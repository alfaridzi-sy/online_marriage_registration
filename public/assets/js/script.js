...
$(document).on('click', function (event) {
    // Check if the clicked element is not a dropdown button or dropdown menu
...
// Show dropdown menu when clicking the dropdown button
$('[data-bs-toggle="dropdown"]').on('click', function (event) {
    // Close other dropdowns
    $('.dropdown-menu').not($(this).next('.dropdown-menu')).removeClass('show');

    // Toggle the dropdown menu
    $(this).next('.dropdown-menu').toggleClass('show').css({
        'position': 'absolute',
        'inset': '0px auto auto 0px',
        'margin': '0px',
        'transform': 'translate3d(-76px, 37px, 0px)'
    });
